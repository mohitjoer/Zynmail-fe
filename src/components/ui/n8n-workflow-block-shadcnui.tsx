...
const colorClasses: Record<string, string> = {
  emerald: "border-emerald-400/40 bg-emerald-400/10 text-emerald-600 dark:text-emerald-400",
  blue: "border-blue-400/40 bg-blue-400/10 text-blue-600 dark:text-blue-400",
  amber: "border-amber-400/40 bg-amber-400/10 text-amber-600 dark:text-amber-400",
  purple: "border-purple-400/40 bg-purple-400/10 text-purple-600 dark:text-purple-400",
  indigo: "border-indigo-400/40 bg-indigo-400/10 text-indigo-600 dark:text-indigo-400",
};
...
function WorkflowConnectionLine({
  ...
  return (
    <path
      ...
      strokeLinecap="round"
      opacity={0.35}
      className="text-foreground text-gray-400"
    />
  );
}
    ...
    <div className="relative w-full overflow-hidden rounded-2xl border border-border/40 bg-background/60 backdrop-blur p-4 sm:p-6">
      ...
      <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          <Badge
            variant="outline"
            className="rounded-full border-emerald-400/40 bg-emerald-400/10 px-3 py-1 text-xs font-semibold uppercase tracking-[0.25em] text-emerald-500"
          >
            Active
          </Badge>
